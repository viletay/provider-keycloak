...
import (
	...
	v1alpha11 "github.com/viletay/provider-keycloak/apis/openidclient/v1alpha1"
	v1alpha1 "github.com/viletay/provider-keycloak/apis/realm/v1alpha1"
	v1alpha12 "github.com/viletay/provider-keycloak/apis/role/v1alpha1"
...
func (mg *ProtocolMapper) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		...
		To: reference.To{
			List:    &v1alpha11.ClientScopeList{},
			Managed: &v1alpha11.ClientScope{},
		},
	})
	if err != nil {
